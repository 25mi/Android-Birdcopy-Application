...
public class FlyingPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link FlyingPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link FlyingPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(FlyingPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link FlyingPlayer#onRenderers} or
     * {@link FlyingPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
