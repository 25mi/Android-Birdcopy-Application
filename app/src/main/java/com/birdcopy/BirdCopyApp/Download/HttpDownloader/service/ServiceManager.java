...
public class ServiceManager {
	...
	public static ServiceManager getInstance() {
		...
		if(mManager == null) {
			mManager = new ServiceManager(MyApplication.getInstance());
		}
		return mManager;
	}
	...
	public void connectService()
    {
        ...
        intent.setClass(MyApplication.getInstance().getApplicationContext(), com.birdcopy.BirdCopyApp.Download.HttpDownloader.service.DownloadService.class);
