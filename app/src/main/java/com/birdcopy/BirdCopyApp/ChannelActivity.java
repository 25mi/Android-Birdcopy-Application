...
import com.birdcopy.BirdCopyApp.Component.Base.BaseActivity;
import com.birdcopy.BirdCopyApp.ChannelManage.ChannelItem;
import com.birdcopy.BirdCopyApp.Component.UI.DragGrid;
import com.birdcopy.BirdCopyApp.Component.UI.OtherGridView;
...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
	...
	public void onBackPressed() {
		...
		if(userAdapter.isListChanged()){
			...
			setResult(ShareDefine.CHANNELRESULT, intent);
			finish();
			Log.d(TAG, "数据发生改变");
		}else{
			super.onBackPressed();
