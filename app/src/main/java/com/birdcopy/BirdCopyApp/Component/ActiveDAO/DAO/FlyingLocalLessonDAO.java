...
import com.birdcopy.BirdCopyApp.Component.ActiveDAO.BE_LOCAl_LESSON;
...
public class FlyingLocalLessonDAO {

    private BE_LOCAl_LESSONDao lessonDao;

    public FlyingLocalLessonDAO()
    {
        lessonDao = MyApplication.getDaoSession(MyApplication.getInstance()).getBE_LOCAl_LESSONDao();
    }

    public FlyingLocalLessonDAO(Context context)
    {
        lessonDao = MyApplication.getDaoSession(context).getBE_LOCAl_LESSONDao();
    }
