...
public class FlyingStatisticDAO {
    ...
    {
        statisticDAO = MyApplication.getDaoSession(MyApplication.getInstance()).getBE_STATISTICDao();
    }

    public  FlyingStatisticDAO(Context context)
    {
        statisticDAO = MyApplication.getDaoSession(context).getBE_STATISTICDao();
    }
