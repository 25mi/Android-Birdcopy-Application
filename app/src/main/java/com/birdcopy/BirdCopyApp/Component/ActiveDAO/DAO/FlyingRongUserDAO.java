...
import com.birdcopy.BirdCopyApp.Component.ActiveDAO.BE_RongUserDao;
...
public class FlyingRongUserDAO {
    ...
    {
        rongUserDao = MyApplication.getDaoSession(MyApplication.getInstance()).getBE_RongUserDao();
    }

    public  FlyingRongUserDAO(Context context)
    {
        rongUserDao = MyApplication.getDaoSession(context).getBE_RongUserDao();
    }
