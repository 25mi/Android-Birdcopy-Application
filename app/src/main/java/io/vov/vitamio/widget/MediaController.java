...
public class MediaController extends FrameLayout {
  ...
  private ImageButton mOutButton;
  ...
  private View.OnClickListener mPauseListener = new View.OnClickListener() {
    ...
    private View.OnClickListener mOutListener = new View.OnClickListener()
    {
        public void onClick(View v) {
  ...
  private boolean initController(Context context) {
    ...
    public void setplayActivity(Activity playActivity)
    {
  ...
  private void initControllerView(View v) {
    mOutButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_out", "id", mContext.getPackageName()));
    if (mOutButton != null) {
        mOutButton.setOnClickListener(mOutListener);
    }
